...
# MT6835-spezifischer Monitor. Basierend auf as5600_monitor.ps1, fokussiert auf MT-Statusbits.
...
$groupLive.Location = New-Object System.Drawing.Point(14, 120)
$groupLive.Size = New-Object System.Drawing.Size(860, 220)
...
$lblMlTitle.Text = "SCHWACH MAGNET"
...
$toolTip.SetToolTip($lblMdTitle, "UEBERD: Ãœberdrehzahl (1 = Ãœberschreitung erkannt)")
$toolTip.SetToolTip($lblMlTitle, "SCHW: Magnet zu schwach (1 = zu schwach)")
$toolTip.SetToolTip($lblMhTitle, "UV: Unterspannung (1 = Unterspannung erkannt)")
...
$lblSystemTitle.Location = New-Object System.Drawing.Point(20, 126)
$lblSystemTitle.AutoSize = $true
$groupLive.Controls.Add($lblSystemTitle)

$lblSystemValue = New-Object System.Windows.Forms.Label
$lblSystemValue.Text = "BOARD=- ENC=MT6835 EN=- MODE=- BRAKE=- FAULT=- ST=- | E=- OC=- OT=- WD=- LAT=- ENCF=- | IA=-A TQ=-Nm SP=- DUTY=-"
$lblSystemValue.Location = New-Object System.Drawing.Point(20, 150)
...
$toolTip.SetToolTip($lblSystemValue, "Systemstatus: ENC=MT6835, EN=Enabled, MODE=Regelmodus, weitere Flags")
$txtLog = New-Object System.Windows.Forms.TextBox
$txtLog.Location = New-Object System.Drawing.Point(14, 350)
$txtLog.Size = New-Object System.Drawing.Size(860, 285)
...
# ZusÃ¤tzliche FlÃ¤che fuer Register-Dump (einfacher Viewer)
$txtRegs = New-Object System.Windows.Forms.TextBox
$txtRegs.Location = New-Object System.Drawing.Point(14, 640)
$txtRegs.Size = New-Object System.Drawing.Size(860, 0)
$txtRegs.Multiline = $true
$txtRegs.ScrollBars = "Vertical"
$txtRegs.ReadOnly = $true
$txtRegs.Font = New-Object System.Drawing.Font("Consolas", 9)
# Derzeit nicht sichtbar â€“ Platzhalter fuer spaetere Erweiterungen
$form.Controls.Add($txtRegs)
...
function ConvertFrom-TelemetryLine {
    ...
    # Fokussiert auf MT6835-formatierte ALIVE/Status-Zeilen.
    ...
    elseif ($line -match "ENC angle raw=(\d+)") {
        $lblEncValue.Text = $Matches[1]
    }
    elseif ($line -match "MT6835 REG live raw=(\d+)") {
        $lblEncValue.Text = $Matches[1]
    }
    ...
    elseif ($line -match "ovspd=(\d).*weak=(\d).*uv=(\d)") {
        Set-BitLabel -Label $lblMdValue -Value ([int]$Matches[1])
        Set-BitLabel -Label $lblMlValue -Value ([int]$Matches[2])
        Set-BitLabel -Label $lblMhValue -Value ([int]$Matches[3])
    }

    # Allgemeine Felder extrahieren
